<%-- 
    ...
    Created on : Mar 14, 2024, 5:36:02 AM
    Author     : hi2ot
--%>
    ...
    <body>                    
        ...
        <main>
            ...
            <section class="contact-section section-padding">
                <div class="container">
                    <div class="row">
                        <c:if test="${infocheck == null}">
                            <div class="col-lg-8 col-12 mx-auto">
                                <h2 class="text-center mb-4">Enter Your Security Information</h2>
                                ...
                                <div class="tab-content shadow-lg mt-5" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-ContactForm" role="tabpanel"
                                        ...
                                        <form class="custom-form contact-form mb-5 mb-lg-0" action="ForgetPassword" method="post"
                                              role="form">
